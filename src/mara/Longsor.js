...
function PrimarySearchAppBar(props) {
  ...
  return (
    <>
    <img src={require("../img/longsor_logo.png")} alt="" style={{position:"absolute", width:"15%", marginLeft:"40%", marginTop:"2%", zIndex:"-1"}}/>
      ...
      <Table className={classes.table}>
        <TableHead style={{backgroundColor:"#f5f5f5"}}>
          <TableRow>
            ...
            <TableCell/>
            <TableCell align="center"><Typography color="textSecondary" style={{padding:"10px", backgroundColor:"tomato", borderRadius:"5px"}}><b>Longsor</b></Typography></TableCell>
          </TableRow>
        </TableHead>
      <TableBody>
      <TableRow>
